...
**Current status:** v1.9.0.0 ready to build — Microsoft Store crash fix (26200.8655): SW unregistration on launch + sw.js excluded from MSIX + Inter font bundled locally. Includes all v1.9 OpsMentor intelligence upgrades.
