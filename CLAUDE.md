...
src/
  ...
  lib/
    ...
    exportExcel.js        — 16-sheet styled Excel export using xlsx-js-style; sheet 4 "Mission Intel" renders buildRuleBasedMissionIntel + buildStructuralMap + buildFunctionalFlow (ASCII maps in monospace dark-fill rows); UUM Items sheet includes custom UUM entries (✦ suffix, CUSTOM status)
