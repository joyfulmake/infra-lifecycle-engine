// Infra domain catalog — this is the ORIGINAL content that used to live at
// the top of src/store/useStore.js, moved here unchanged so it has the same
// shape as the other domain catalogs (cloudMigration.js, sapPm.js, etc.) and
// applyDomain.js can restore it without a circular import back into
// useStore.js. useStore.js imports and re-exports these same bindings, so
// every existing consumer (PhasePanel, SystemDesignTab) is unaffected.
